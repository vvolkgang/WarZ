...
namespace WarZ
{
    public class ChaseCamera:Camera
    {
        ...
        private Vector3 _targetOffset = new Vector3(0, 2.8f, 0);
        #endregion
        ...
        public ChaseCamera(Game game, Vector3 position, Vector3 target, Vector3 up)
        ...
        private void UpdateWorldPositions()
        {
            ...
            transform.Up = _up;
            transform.Right = Vector3.Cross(ChaseDirection, _up);
            
            Vector3 normalizedOffset = Vector3.Normalize(_offset);

            // Calculate desired camera properties in world space
            desiredPosition = _position +
                Vector3.TransformNormal(normalizedOffset, transform);
           // _target = _position +
            //    Vector3.TransformNormal(normalizedOffset, transform);
        ...
        {
            //e retirado o _offset daqui porque este já é calculado e está metido na _position
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            Vector3 stretch = _position - desiredPosition;
